...
CREATE TABLE `region` (
  ...
  `region_type_id` tinyint(1) unsigned DEFAULT NULL,
...
INSERT INTO `region` VALUES ('CL-RM',6,'Región Metropolitana de Santiago'),('RU-MOS',3,'Moskovskaja oblast\''),('RU-MOW',5,'Moskva'),('RU-TUL',3,'Tul\'skaja oblast\''),('RU-VGG',3,'Volgogradskaja oblast\'');
...
CREATE TABLE `settlement` (
  ...
  `name` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ind_uq` (`country_id`,`region_id`,`settlement_type_id`,`name`),
  KEY `fk_settlement_country_id_idx` (`country_id`),
  KEY `fk_settlement_region_id_idx` (`region_id`),
  KEY `fk_settlement_settlement_type_id_idx` (`settlement_type_id`),
  KEY `fk_settlement_district_id_idx` (`district_id`),
  CONSTRAINT `fk_settlement_country_id` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`),
  CONSTRAINT `fk_settlement_district_id` FOREIGN KEY (`district_id`) REFERENCES `district` (`id`),
  CONSTRAINT `fk_settlement_region_id` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`),
...
INSERT INTO `settlement` VALUES (1,'RU','RU-MOW',1,1,'Moskva'),(2,'RU','RU-MOS',2,2,'Sergiev Posad'),(3,'CL','CL-RM',3,1,'Santiago'),(4,'RU','RU-TUL',4,3,'Yasnaya Polyana'),(5,'RU','RU-VGG',5,2,'Volzhsky');
...
-- Dump completed on 2020-10-27 21:19:42
